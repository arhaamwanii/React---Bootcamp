export default function TabButton({buttonInfo , onSelect , children , isSelected}){

    return(
        <>
            <li>
                <button className={isSelected ? "active" : undefined} onClick={onSelect} >{buttonInfo} {children}</button>
            </li>
        </>
